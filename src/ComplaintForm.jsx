  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white opacity-20 blur-3xl"></div>

      </div>

      <div className="relative z-10 flex justify-center items-center min-h-screen px-5 py-10">

        <div className="w-full max-w-3xl rounded-3xl border border-white/20 bg-slate-900 border border-slate-800 shadow-2xl">

          {/* Back Button */}

          <button
            onClick={() => navigate("/dashboard")}
            className="flex items-center gap-2 text-orange-300 hover:text-orange-400 transition mb-8"
          >
            <ArrowLeft size={20} />
            Back to Dashboard
          </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-2xl bg-slate-900/80 border border-slate-700 py-4 pl-12 pr-4 text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-orange-500
...
focus:border-orange-500"
            ...
            <div className="relative">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full rounded-2xl bg-slate-900/80 border border-slate-700 py-4 pl-12 pr-4 text-white placeholder:text-slate-400 resize-none focus:outline-none focus:ring-2 focus:ring-emerald-500
...
from-orange-500
to-emerald-600 py-4 text-white font-bold"
            >
              {analyzing
                ? "Analyzing Complaint..."
                : "🤖 Analyze with AI"}
            ...
            {departmentInfo && (
              <div className="bg-slate-900 border border-orange-500 rounded-2xl p-5 text-white">
          ...
          ${selected
                          ? "border-orange-400 bg-emerald-500/20 shadow-lg shadow-emerald-500/20 scale-105"
                          : "border-slate-700 bg-slate-900/70 hover:border-emerald-500 hover:scale-105"
                        }`}
                    >
            ...
            <div>
              ...
              <div className="flex justify-between items-center mb-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-orange-300 hover:text-orange-200 transition"
                >
                  <LocateFixed size={18} />
            ...
            <div>
              ...
              {!image ? (
                ...
                <label
                  className="cursor-pointer border-2 border-dashed border-slate-600 rounded-2xl p-8 flex flex-col items-center justify-center hover:border-orange-500 transition"
                >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full rounded-2xl bg-gradient-to-r from-orange-500 to-emerald-600 py-5 text-lg font-bold text-white shadow-xl transition-all duration-300 hover:scale-[1.02] hover:-translate-y-1 hover:shadow-orange-500/50"
            >

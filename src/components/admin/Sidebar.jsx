...
function Sidebar() {
  const menus = [
    ...
    { icon: <FileText size={20} />, name: "All Complaints" },
    { icon: <Trophy size={20} />, name: "Priority Ranking" },
    { icon: <MapPin size={20} />, name: "Hotspots" },
    { icon: <Bot size={20} />, name: "AI Civic Report" },
    { icon: <Gift size={20} />, name: "Schemes" },
    { icon: <BarChart3 size={20} />, name: "Analytics" },
    { icon: <Users size={20} />, name: "Users" },
    { icon: <MessageSquare size={20} />, name: "Feedback" },
    ...
    <aside className="w-72 bg-slate-950 border-r border-slate-800 min-h-screen flex flex-col">
      ...
      <div className="p-5 border-t border-slate-800">
        ...
        <div className="bg-slate-900 rounded-2xl p-4">
          ...
          <button className="mt-4 w-full rounded-xl bg-gradient-to-r from-orange-500 to-emerald-600 py-3 text-white flex justify-center items-center gap-2 hover:scale-[1.02] transition">
            <Download size={18} />
            Download PDF
          </button>
